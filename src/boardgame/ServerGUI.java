...
implements BoardPanel.BoardPanelListener  {
    ...
    protected static final String[] PLAYER_CLASSES = {"student_player.AlphaBetaOriginal", "student_player.AlphaBetaOptimized", "student_player.MiniMax", "hus.RandomHusPlayer"};
